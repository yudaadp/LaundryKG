          ...
          <form action="<?=getmods_info(GET_MOD, 'DIR_PATH');?>"
					...
					<div class="col-lg-12">
						<div class="form-group">
							<label for="Modal Name">Menu</label> <select
								class="selectpicker form-control" data-style="btn-primary"
								style="display: none;" name="mn_id" id="mn_id">
                  <?php
									foreach ( $data as $mn ) {
										echo '<option value="' . $mn ['mod_name'] .'">' . ucwords ( $mn ['mod'] ) . '</option>';
									}
									?>
                  </select>
						</div>
					...
					<div class="modal-footer">
						<button class="btn btn-success crud-submit" id="goSave" type="submit">Confirm</button>
