...
if (! defined ( '__CLASS_QRCODE__' )) {
	...
	class QRcode {
		 ...
		 *
		 * @param
		 *        	string message a encoder
		 * @param
		 *        	string niveau de correction d'erreur (ECC) : L, M, Q, H
		 * @return null
		 */
		 ...
		 *        	float position Y
		 * @param
		 *        	float taille du qrcode
		 * @param
		 *        	array couleur du background (R,V,B)
		 * @param
		 *        	array couleur des cases et du border (R,V,B)
		 * @return boolean true;
		 */
		...
		private function loadECC() {
			...
			fclose ( $fp1 );
			$this->format_information_x1 = array (
					0,
					1,
					2,
					3,
			...
			$this->format_information_y1 = array (
					8,
					8,
					8,
					8,
