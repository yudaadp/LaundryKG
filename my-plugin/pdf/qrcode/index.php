...
<meta name="Title"
	content="Spipu - Qrcode <?php echo __CLASS_QRCODE__; ?>">
...
<body>
	<center>
		<form method="GET" action="">
			<textarea name="msg" cols="40" rows="7"><?php echo htmlentities($msg); ?></textarea>
			<br> Correction d'erreur : <select name="err">
...
$qrcode->displayHTML ();
?>
			<br> Génération d'une image PNG : <br> <img
			src="./image.php?msg=<?php echo urlencode($msg); ?>&amp;err=<?php echo urlencode($err); ?>"
