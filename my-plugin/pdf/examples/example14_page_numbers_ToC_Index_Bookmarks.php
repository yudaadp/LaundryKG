...
for($j = 1; $j < 7; $j ++) {
	...
	if ($j == 3)
		$mpdf->WriteHTML ( '<pagebreak resetpagenum="1" pagenumstyle="a" />', 2 );
	if ($j == 4)
		$mpdf->WriteHTML ( '<pagebreak resetpagenum="0" pagenumstyle="i" />', 2 );
	if ($j == 5)
		$mpdf->WriteHTML ( '<pagebreak resetpagenum="0" pagenumstyle="1" />', 2 );
	if ($j == 6)
		$mpdf->WriteHTML ( '<pagebreak resetpagenum="1" pagenumstyle="I" type="NEXT-ODD" /><div style="color:#AA0000">ODD</div>', 2 );
	for($x = 1; $x < 7; $x ++) {
