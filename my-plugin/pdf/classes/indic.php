...
'R',
	...
	public static function set_syllables(&$o, $s, &$broken_syllables) {
		...
		while ( $ptr < strlen ( $s ) ) {
			...
			// From OT spec:
			else if (($ptr == 0 || $o [$ptr - 1] ['general_category'] < UCDN::UNICODE_GENERAL_CATEGORY_LOWERCASE_LETTER || $o [$ptr - 1] ['general_category'] > UCDN::UNICODE_GENERAL_CATEGORY_NON_SPACING_MARK) && 
