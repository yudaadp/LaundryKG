...
$config = array(
	...
	|
	*/
	'base_url' => $get_content->my_setting('base_url'),
		 ...
		 * |
		 */
		'upload_dir' => '/my-content/files/image/',
	/*
	|--------------------------------------------------------------------------
	...
	|
	*/
	'current_path' => '../../my-content/files/image/',
	...
	|
	*/
	'thumbs_base_path' => '../../my-content/files/thumbs/',
	...
	*/
	...
	'ftp_thumbs_dir' => '/thumbs/',
		 ...
		 */
		'access_keys' => array (
				md5 ( $_SESSION ['mywebs_uid'] . session_id () ) 
		),
