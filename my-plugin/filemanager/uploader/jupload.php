...
class JUpload {
	 ...
	 * for setting applet properties via JavaScript.
	 * This is necessary,
	...
	/**
	 * Example function to process the files uploaded.
	 * This one simply displays the files' data.
	 */
	...
	/**
	 * Generation of the applet tag, and necessary things around (js content).
	 * Insertion of this into the content of the
	 * page.
	...
	/**
	 * This function is called when constructing the page, when we're not reveiving uploaded files.
	 * It 'just' construct
	 ...
	 * It manage the files sent by the applet, check the incoming parameters (md5sum) and
