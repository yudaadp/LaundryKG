...
class FtpClient implements Countable {
	 ...
	 *        	The memory limit, if null is not modified
	 * @param int $time_limit
	 *        	The max execution time, unlimited by default
	 * @param bool $ignore_user_abort
	 *        	Ignore user abort, true by default
	 * @return FtpClient
	 */
	 ...
	 *        	The directory, by default is "." the current directory
	 * @param bool $recursive        	
	 * @param callable $filter
	 *        	A callable to filter the result, by default is asort() PHP function.
	 ...
	 * @param string $directory        	
	 * @param bool $recursive
	 *        	Forces deletion if the directory is not empty
	 * @return bool
	 ...
	 * @param bool $recursive
	 *        	Is effective only if $path is a directory, {@see FtpClient::rmdir()}
	 * @return bool
	 */
	 ...
	 *        	The type of item to count (file, directory, link, unknown)
	 * @param bool $recursive
	 *        	true by default
	 * @return int
	 */
	 ...
	 * ..) to type (file, directory, link, unknown).
